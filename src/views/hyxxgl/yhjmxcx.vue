<template>
  <div class="smain">
    ...
    <el-form :inline="true" :model="formInline" size="small" class="demo-form-inline">
      ...
      <el-form-item>
        <el-select v-model="formInline.lyqd" filterable placeholder="来源渠道" style="width:150px;">
          <el-option v-for="item in optlyqd" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
        <el-select v-model="formInline.zt" filterable placeholder="状态" style="width:150px;">
          <el-option v-for="item in optzt" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
        <el-select v-model="formInline.yxrq" filterable placeholder="有效日期" style="width:150px;">
          <el-option v-for="item in optyxrq" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      <!-- 右侧按钮 -->
    ...
    <div class="stable">
      ...
      <el-table :data="tableData" @sort-change="sortChange" v-loading="loading" style="width:100%" border>
        ...
        <el-table-column prop="lyqd" label="来源渠道" align="center"> </el-table-column>
        <el-table-column prop="zt" label="状态" align="center"> </el-table-column>
        <el-table-column prop="yxksrq" label="有效开始日期" align="center"> </el-table-column>
        <el-table-column prop="yxjsrq" label="有效结束日期" align="center"> </el-table-column>
      </el-table>
    </div>
    <!-- 分页 -->
